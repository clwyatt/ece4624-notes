...
format: 
  ...
  beamer:
    ...
    output-file: lecture-02-slides.pdf
    fontsize: 8pt
...
* single input - single output (SISO) system.
  ...
  ![SISO Block Diagram ](figures/fig6_1){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a single-input, single-output system"}
...
* single input - multiple output (SIMO) system
  ...
  ![SIMO Block Diagram ](figures/fig6_2){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a single-input, multiple-output system"}

* general case, multiple input - multiple output (MIMO)

  ![MIMO Block Diagram ](figures/fig6_3){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a multiple-input, multiple-output system"}
...
- If both input and output are CT signals, it is a CT system.
  ...
  ![Generic Block Diagram of CT System](figures/fig6_4){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a CT system"}


- If both input and output are DT signals, it is a DT system.

  ![Generic Block Diagram of a DT System](figures/fig6_5){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a DT system"}
...
- If input and output are not both CT or DT signals, it is a hybrid
  ...
  ![Generic Block Diagram of a Hybrid DT/CT System](figures/fig6_6){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a hybrid system with DT input and CT output"}
  
  ![Generic Block Diagram of a Hybrid CT/DT System](figures/fig6_7){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a hybrid system with CT input and DT output"}
...
* The impulse response for CT systems is denoted $h(t)$.
  ...
  ![Impulse Response of CT System](figures/figA_1){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a CT system with impulse as input"}
  
* The impulse response for DT systems is denoted $h[n]$.

  ![Impulse Response of DT System](figures/figA_2){width=40% fig-align="center" fig-alt="diagram showing the block diagram of a DT system with impulse as input"}
