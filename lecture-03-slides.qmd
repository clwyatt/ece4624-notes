...
*analysis equation*:
$$\boxed{a_k = \frac{1}{T_0} \int\limits_{0}^{T_0} x(t)e^{-jk\omega_0 t} \; dt}$$
...
![Plot of the example signal.](figures/fig14_1.svg){fig-align="center" fig-alt="See the caption."}
...
![Schematic depiction of analysis of continuous-time systems using Fourier techniques.](figures/fig4_1.svg){fig-align="center" fig-alt="See the caption."}
